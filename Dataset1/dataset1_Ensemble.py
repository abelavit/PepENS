...
file = open("dataset1_B0_inde_test_prob.dat",'rb')
B0_inde_test_prob = pickle.load(file)
file = open("dataset1_CatBoost1_inde_test_prob.dat",'rb')
CatBoost_inde_test_prob = pickle.load(file)
file = open("dataset1_CatBoost2_inde_test_prob.dat",'rb')
CatBoost_inde_test_prob2 = pickle.load(file)
file = open("dataset1_LogisticRegression_inde_test_prob.dat",'rb')
LR_inde_test_prob = pickle.load(file)
file = open("dataset1_inde_test_true_prob.dat",'rb')
