...
#model details: CatBoostClassifier(random_state=0,depth=8, iterations=1300, learning_rate=0.1, eval_metric='AUC', loss_function='Logloss')
loaded_model = CatBoostClassifier()

loaded_model.load_model('dataset2_Catboost_model2.cbm')
